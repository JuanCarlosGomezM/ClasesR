...
plot(tukey)
```
La diferencia más grande se encuentra entre el ancho de sépalo de versicolor y setosa, siendo menor el de versicolor

## Correlación
Sacaremos el coeficiente de correlación de Pearson (r) y el coeficiente muestral de determinación (r**2)
...
r**2
```
entonces r**2 = 0.6188467, es decir que el 61.88% de las variaciones en el ancho del pétalo de versicolor se pueden explicar por los valores de la longitud del pétalo de esta especie. Con la aclaración de que correlación no implica causalidad.
