...
### Falta la conclusión de la regresión lineal
...
También los representamos mediante gráficos de violín para ver la densidad
```{r}
iris %>% filter(Species == "setosa" | Species == "virginica") %>%
  ggplot(aes(Species, Sepal.Length)) +
...
Con esta ecuación resultande de la regresión podemos hacer predicciones de anchos
