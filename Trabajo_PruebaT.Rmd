...
*HA o H1: la media de la longitud de sépalo de setosa es menor que la media de la longitud de sépalo de virgínica.  u1 < u2*
...
*Nuevas hipótesis:*
*H0: no hay diferencia entre las medias de la longitud de sépalo. u1=u2*
*HA o H1: ls media de la longitud de sépalo de setosa es menor que la de virginica.  u1 < u2*
```{r}
